tabPanel("K-Means Clustering", 
         sidebarLayout(
           sidebarPanel(width = 4,
                        ...
                        br(),
                        h5("Create a new clustering template from documents that have already been batch processed."),
                        fileInput("c_upload_proc_list", "Choose the rda file of processed training documents", multiple = FALSE, accept = c('.rda')),
                        fluidRow(
           ...
           mainPanel(width = 8, h1("Sample Tab -- Sample Tab"),
                     tabsetPanel(id = "cluster_set",
                                 tabPanel("Graphs",
                                          verbatimTextOutput("c_datapath"),
                                          verbatimTextOutput("c_template_proc_list")
                                 ),
