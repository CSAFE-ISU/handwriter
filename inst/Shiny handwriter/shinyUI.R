                                       ...
                                       tabPanel("Graph",
                                                ...
                                                fluidRow(
                                                  ...
                                                  column(9, 
                                                     ...
                                                     fluidRow( 
                                                              column(2, offset = 1, strong(id = 'graph_width', "width")), column(2, textOutput("features_graph_width")),
                                                              column(2, strong(id = 'graph_topmost_row', "topmost_row")), column(2, textOutput("features_graph_topmost_row"))),
                                                     fluidRow(style = "background-color:#ECECEC;", 
                                                              column(2, offset = 1, strong(id = 'graph_bottom_row', "bottom_row")), column(2, textOutput("features_graph_bottom_row")),
                                                              column(2, strong(id = 'graph_leftmost_col', "leftmost_col")), column(2, textOutput("features_graph_leftmost_col"))),
                                                     fluidRow(
                                                              column(2, offset = 1, strong(id = 'graph_rightmost_col', "rightmost_col")), column(2, textOutput("features_graph_rightmost_col")),
                                                              column(2, strong(id = 'graph_centroid_index', "centroid_index")), column(2, textOutput("features_graph_centroid_index"))),
                                                     fluidRow(style = "background-color:#ECECEC;", 
                                                              column(2, offset = 1, strong(id = 'graph_centroid_y', "centroid_y")), column(2, textOutput("features_graph_centroid_y")), 
                                                              column(2, strong(id = 'graph_centroid_x', "centroid_x")), column(2, textOutput("features_graph_centroid_x"))),
                                                     fluidRow(
                                                              column(2, offset = 1, strong(id = 'graph_horiz_location', "centroid_horiz_location")), column(2, textOutput("features_graph_centroid_horiz_location")),
                                                              column(2, strong(id = 'graph_vert_location', "centroid_vert_location")), column(2, textOutput("features_graph_centroid_vert_location"))),
                                                     fluidRow(style = "background-color:#ECECEC;",
                                                              column(2, offset = 1, strong(id = 'graph_lHalf', "lHalf")), column(2, textOutput("features_graph_lHalf")),
                                                              column(2, strong(id = 'graph_rhalf', "Rhalf")), column(2, textOutput("features_graph_rHalf"))),
                                                     fluidRow(
                                                       column(2, offset = 1, strong(id = 'graph_disjoint_centroids_left', "disjoint_centroids$left")), column(2, textOutput("features_graph_disjoint_centroids_left")),
                                                       column(2, strong(id = 'graph_disjoint_centroids_right', "disjoint_centroids$right")), column(2, textOutput("features_graph_disjoint_centroids_right"))),
                                                     fluidRow(style = "background-color:#ECECEC;",
                                                              column(2, offset = 1, strong(id = 'graph_slope', "slope")), column(2, textOutput("features_graph_slope")),
                                                              column(2, strong(id = 'graph_pixel_density', "pixel_density")), column(2, textOutput("features_graph_pixel_density"))),
                                                     fluidRow(
                                                       column(2, offset = 1, strong(id = 'graph_box_density', "box_density")), column(2, textOutput("features_graph_box_density")),
                                                       column(2, strong(id = 'graph_uniqueid', "uniqueid")), column(2, textOutput("features_graph_uniqueid"))),
                                                     fluidRow(style = "background-color:#ECECEC;",
                                                              column(2, offset = 1, strong(id = 'graph_down_dist', "down_dist")), column(2, textOutput("features_graph_down_dist")),
                                                              column(2, strong(id = 'graph_line_number', "line_number")), column(2, textOutput("features_graph_line_number"))),
                                                     # fluidRow(
                                                     #   column(2, offset = 1, strong(id = 'graph_order_within_line', "order_within_line")), column(2, textOutput("features_graph_order_within_line")),
                                                     #   column(2, strong(id = 'graph_l_neighbor_dist', "l_neighbor_dist")), column(2, textOutput("features_graph_l_neighbor_dist"))),
                                                     # fluidRow(style = "background-color:#ECECEC;",
                                                     #          column(2, offset = 1, strong(id = 'graph_down_dist', "down_dist")), column(2, textOutput("features_graph_down_dist")),
                                                     #          column(2, strong(id = 'graph_line_number', "line_number")), column(2, textOutput("features_graph_line_number"))),
                                                     ...
                                                     #from here
                                                     fluidRow(style = "background-color:#ECECEC;",
                                                              column(2, offset = 1, strong(id = 'graph_r_neighbor_dist', "r_neighbor_dist")), column(2, textOutput("features_graph_r_neighbor_dist")),
                                                              column(2, strong(id = 'graph_xvar', "xvar")), column(2, textOutput("features_graph_xvar"))),
                                                     fluidRow(
                                                       column(2, offset = 1, strong(id = 'graph_yvar', "yvar")), column(2, textOutput("features_graph_yvar")),
                                                       column(2, strong(id = 'graph_covar', "covar")), column(2, textOutput("features_graph_covar"))),
                                                     fluidRow(style = "background-color:#ECECEC;",
                                                              column(2, offset = 1, strong(id = 'graph_wordIndex', "wordIndex")), column(2, textOutput("features_graph_wordIndex"))
                                                              #column(2, strong(id = 'graph_line_number', "line_number")), column(2, textOutput("features_graph_line_number"))
                                                              )
                                                )  
                                              )
