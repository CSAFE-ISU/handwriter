...
#' [`make_clustering_template`]. This template was created from handwriting
...
#'   algorithm.}
#' \item{WithinClustDists}{The within cluster
...
#'   was assigned  on each iteration. The output of [`make_clustering_template`] stores
