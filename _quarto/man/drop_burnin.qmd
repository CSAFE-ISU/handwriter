## Drop Burn-In {.unnumbered}


### Description

<code>drop_burnin()</code> removes the burn-in from the Markov Chain Monte Carlo (MCMC) draws.
...
<tr><td style = "white-space: nowrap; font-family: monospace; vertical-align: top"><code id="burn_in">burn_in</code></td>
<td>
