## Example cluster template {.unnumbered}


### Description

An example cluster template created with <code>make_clustering_template()</code>. The
...
<code>make_clustering_template()</code>. The cluster template was created by sorting
