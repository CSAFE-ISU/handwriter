## Calculate Accuracy {.unnumbered}


### Description

Fit a model with <code>fit_model()</code> and calculate posterior probabilities of
writership with <code>analyze_questioned_documents()</code> of a set of test documents
