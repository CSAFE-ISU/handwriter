...
Development on <code>read_and_process()</code> is complete. We recommend using <code>processDocument()</code>.
...
<table>
<tr><td style = "white-space: nowrap; font-family: monospace; vertical-align: top"><code id="image_name">image_name</code></td>
<td>
The file path to an image
</td></tr>
<tr><td style = "white-space: nowrap; font-family: monospace; vertical-align: top"><code id="transform_output">transform_output</code></td>
<td>
