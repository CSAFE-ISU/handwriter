...
The next step is to fit a Bayesian hierarchical model **add reference to Amy's paper**. 

We will use the model training handwriting documents included in handwriter. Get the file path to these documents.
```{r}
