...
# The functions in this script create `example_cluster_template`, `example_model_1chain`, 
# `example_model_2chains`, `example_analysis_1chain`, and `example_analysis_2chains` and
# save them in the data folder as rda files.
